...
@ffi.DefaultAsset('darwin_native_bindings')
library;
...
@ffi.Native<CMTime Function(ffi.Double, ffi.Int32)>()
external CMTime CMTimeMakeWithSeconds(
  double seconds,
  int preferredTimescale,
);

@ffi.Native<ffi.Double Function(CMTime)>()
external double CMTimeGetSeconds(
  CMTime time,
);
...
@ffi.Native<ffi.Pointer<objc.ObjCObject>>(symbol: 'MPNowPlayingInfoPropertyElapsedPlaybackTime')
external ffi.Pointer<objc.ObjCObject> _MPNowPlayingInfoPropertyElapsedPlaybackTime;

objc.NSString get MPNowPlayingInfoPropertyElapsedPlaybackTime =>
    objc.NSString.castFromPointer(_MPNowPlayingInfoPropertyElapsedPlaybackTime, retain: true, release: true);

set MPNowPlayingInfoPropertyElapsedPlaybackTime(objc.NSString value) {
  objc.NSString.castFromPointer(
    _MPNowPlayingInfoPropertyElapsedPlaybackTime,
    retain: false,
    release: true,
  ).ref.release();
  _MPNowPlayingInfoPropertyElapsedPlaybackTime = value.ref.retainAndReturnPointer();
}

@ffi.Native<ffi.Pointer<objc.ObjCObject>>(symbol: 'MPNowPlayingInfoPropertyPlaybackRate')
external ffi.Pointer<objc.ObjCObject> _MPNowPlayingInfoPropertyPlaybackRate;

objc.NSString get MPNowPlayingInfoPropertyPlaybackRate =>
    objc.NSString.castFromPointer(_MPNowPlayingInfoPropertyPlaybackRate, retain: true, release: true);

set MPNowPlayingInfoPropertyPlaybackRate(objc.NSString value) {
  objc.NSString.castFromPointer(_MPNowPlayingInfoPropertyPlaybackRate, retain: false, release: true).ref.release();
  _MPNowPlayingInfoPropertyPlaybackRate = value.ref.retainAndReturnPointer();
}
...
late final _class_DispatchQueueShim = objc.getClass("musique.DispatchQueueShim");
late final _sel_main = objc.registerName("main");

/// DispatchQueueShim
class DispatchQueueShim extends objc.NSObject {
  DispatchQueueShim._(ffi.Pointer<objc.ObjCObject> pointer, {bool retain = false, bool release = false})
    : super.castFromPointer(pointer, retain: retain, release: release);

  /// Constructs a [DispatchQueueShim] that points to the same underlying object as [other].
  DispatchQueueShim.castFrom(objc.ObjCObjectBase other) : this._(other.ref.pointer, retain: true, release: true);

  /// Constructs a [DispatchQueueShim] that wraps the given raw object pointer.
  DispatchQueueShim.castFromPointer(ffi.Pointer<objc.ObjCObject> other, {bool retain = false, bool release = false})
    : this._(other, retain: retain, release: release);

  /// Returns whether [obj] is an instance of [DispatchQueueShim].
  static bool isInstance(objc.ObjCObjectBase obj) {
    return _objc_msgSend_19nvye5(obj.ref.pointer, _sel_isKindOfClass_, _class_DispatchQueueShim);
  }

  /// main
  static objc.NSObject getMain() {
    final _ret = _objc_msgSend_151sglz(_class_DispatchQueueShim, _sel_main);
    return objc.NSObject.castFromPointer(_ret, retain: true, release: true);
  }

  /// init
  DispatchQueueShim init() {
    objc.checkOsVersionInternal('DispatchQueueShim.init', iOS: (false, (2, 0, 0)), macOS: (false, (10, 0, 0)));
    final _ret = _objc_msgSend_151sglz(this.ref.retainAndReturnPointer(), _sel_init);
    return DispatchQueueShim.castFromPointer(_ret, retain: false, release: true);
  }

  /// new
  static DispatchQueueShim new$() {
    final _ret = _objc_msgSend_151sglz(_class_DispatchQueueShim, _sel_new);
    return DispatchQueueShim.castFromPointer(_ret, retain: false, release: true);
  }

  /// allocWithZone:
  static DispatchQueueShim allocWithZone(ffi.Pointer<objc.NSZone> zone) {
    final _ret = _objc_msgSend_1cwp428(_class_DispatchQueueShim, _sel_allocWithZone_, zone);
    return DispatchQueueShim.castFromPointer(_ret, retain: false, release: true);
  }

  /// alloc
  static DispatchQueueShim alloc() {
    final _ret = _objc_msgSend_151sglz(_class_DispatchQueueShim, _sel_alloc);
    return DispatchQueueShim.castFromPointer(_ret, retain: false, release: true);
  }

  /// self
  DispatchQueueShim self$1() {
    final _ret = _objc_msgSend_151sglz(this.ref.pointer, _sel_self);
    return DispatchQueueShim.castFromPointer(_ret, retain: true, release: true);
  }

  /// retain
  DispatchQueueShim retain() {
    final _ret = _objc_msgSend_151sglz(this.ref.pointer, _sel_retain);
    return DispatchQueueShim.castFromPointer(_ret, retain: true, release: true);
  }

  /// autorelease
  DispatchQueueShim autorelease() {
    final _ret = _objc_msgSend_151sglz(this.ref.pointer, _sel_autorelease);
    return DispatchQueueShim.castFromPointer(_ret, retain: true, release: true);
  }

  /// Returns a new instance of DispatchQueueShim constructed with the default `new` method.
  factory DispatchQueueShim() => new$();
}
...
late final _sel_setNextTrackCommandCallback_ = objc.registerName("setNextTrackCommandCallback:");
late final _sel_setPreviousTrackCommandCallback_ = objc.registerName("setPreviousTrackCommandCallback:");
late final _sel_setSeekForwardCommandCallback_ = objc.registerName("setSeekForwardCommandCallback:");
late final _sel_setSeekBackwardCommandCallback_ = objc.registerName("setSeekBackwardCommandCallback:");
late final _sel_setTogglePlayPauseCommandCallback_ = objc.registerName("setTogglePlayPauseCommandCallback:");
...
class MPRemoteCommandCenterListener extends objc.NSObject {
  ...
  /// setNextTrackCommandCallback:
  void setNextTrackCommandCallback(objc.ObjCBlock<ffi.Void Function()> callback) {
    _objc_msgSend_f167m6(this.ref.pointer, _sel_setNextTrackCommandCallback_, callback.ref.pointer);
  }

  /// setPreviousTrackCommandCallback:
  void setPreviousTrackCommandCallback(objc.ObjCBlock<ffi.Void Function()> callback) {
    _objc_msgSend_f167m6(this.ref.pointer, _sel_setPreviousTrackCommandCallback_, callback.ref.pointer);
  }

  /// setSeekForwardCommandCallback:
  void setSeekForwardCommandCallback(objc.ObjCBlock<ffi.Void Function()> callback) {
    _objc_msgSend_f167m6(this.ref.pointer, _sel_setSeekForwardCommandCallback_, callback.ref.pointer);
  }

  /// setSeekBackwardCommandCallback:
  void setSeekBackwardCommandCallback(objc.ObjCBlock<ffi.Void Function()> callback) {
    _objc_msgSend_f167m6(this.ref.pointer, _sel_setSeekBackwardCommandCallback_, callback.ref.pointer);
  }

  /// setTogglePlayPauseCommandCallback:
  void setTogglePlayPauseCommandCallback(objc.ObjCBlock<ffi.Void Function()> callback) {
    _objc_msgSend_f167m6(this.ref.pointer, _sel_setTogglePlayPauseCommandCallback_, callback.ref.pointer);
  }
